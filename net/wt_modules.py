...
class WTConv2d(nn.Module):
    def __init__(self, in_channels, out_channels, 
        ...
        self.base_conv = nn.Conv2d(in_channels, in_channels,
                                   kernel_size, padding=padding, stride=1, dilation=1,
...
class DSWTConv2d(nn.Module):
    """
        Depthwise Separable Conv With WT-Conv2d
    """
    def __init__(self, in_channels, out_channels, kernel_size=3, stride=1, padding=1, bias=True):
        super(DSWTConv2d, self).__init__()
...
if __name__ == '__main__':
    ...
    wtconv = DSWTConv2d(in_channels=32, out_channels=32)
    output = wtconv(input)
    print(output.size())
