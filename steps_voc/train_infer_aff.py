...
def get_args_parser():
    ...
    parser.add_argument("--high_alpha", default=3, type=int)
...
def train_affinity(args):
    ...
    pyutils.Logger(os.path.join(args.work_space, 'res38_aff.log'))
    ...
    if dist.get_rank() == 0:
        torch.save(model.module.state_dict(), 
                   os.path.join(args.work_space, 'res38_aff_final.pth'))
